...
// Habilitar el soporte completo para el enrutamiento y el generador de URLs
$app->register(Illuminate\Routing\RoutingServiceProvider::class);
$app->register(Illuminate\Translation\TranslationServiceProvider::class); // Opcional, si usas traducciones
